...
public class PhieuDV {
    ...
    public PhieuDV(int maPhieuDV, int maP, String tenP, String maDV, String tenDV, String giaDV, String tienDV, int soluong, Date ngaySD) {
        MaPhieuDV = maPhieuDV;
        MaP = maP;
        TenP = tenP;
        MaDV = maDV;
    ...
    public PhieuDV(int maPhieuDV,int maP, String maDV, String tenDV, String maLDV, String tenLDV, String giaDV, String tienDV, int soluong, Date ngaySD) {
        MaPhieuDV = maPhieuDV;
        MaDV = maDV;
        MaP = maP;
        TenDV = tenDV;
