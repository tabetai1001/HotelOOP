...
public class PhieuDatPhong {
    ...
    public PhieuDatPhong(int maPDP, int maP, String tenP, String maLP, String tenLP, int maKHACH, String tenKHACH, Date ngayDatPhong, Date ngayTraPhong, String giaPhong, String tienTra) {
        MaPDP = maPDP;
        MaP = maP;
        this.tenP = tenP;
        this.maLP = maLP;
    ...
    public PhieuDatPhong(int maPDP, int maP, String tenP, String tenLP, String tenKHACH, Date ngayDatPhong, Date ngayTraPhong, String giaPhong, String tienTra) {
        MaPDP = maPDP;
        MaP = maP;
        this.tenP = tenP;
        this.tenLP = tenLP;
