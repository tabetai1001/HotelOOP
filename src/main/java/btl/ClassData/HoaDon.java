...
public class HoaDon {
    ...
    public HoaDon(int maHD, int maP, String tongtien, Date ngayInHD, int maNV, String tenNV, int maKHACH, String tenKHACH, String tenP, String giaPhong, String tenLP, String maPDP, Date ngayDP, Date ngayTP, String tienTra) {
        MaHD = maHD;
        MaP = maP;
        Tongtien = tongtien;
        NgayInHD = ngayInHD;
