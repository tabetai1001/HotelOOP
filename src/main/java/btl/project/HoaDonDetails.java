...
public class HoaDonDetails {
    ...
    @FXML
    private TextField txtTienPhong; long tienPhong=0;

    @FXML
    private TextField txtTienDV; long tienDV=0;

    @FXML
    private TextField txtTongTien; long TongTien=0;
    ...
    void ShowHDDetails(){
        ...
        if (phieuDVSsList.size() == 0) tab_ServicesDetails.setDisable(true);
    }
